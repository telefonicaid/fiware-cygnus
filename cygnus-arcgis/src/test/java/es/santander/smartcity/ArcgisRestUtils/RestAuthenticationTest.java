...
public class RestAuthenticationTest implements ArcgisBaseTest{
	...
	public void getPortalTokenTest(){
		...
		try {
			...
			credential = RestAuthentication.createUserToken(PORTAL_USER, PORTAL_PASSWORD, new URL(PORTAL_GENERATE_TOKEN_URL), "https://sags1.int.ayto-santander.es/arcgis/rest/services/Policia");
	...
	public void getOnlineTokenTest(){
		...
		try {
			...
			credential = RestAuthentication.createUserToken(ONLINE_USER, ONLINE_PASSWORD, new URL(ONLINE_GENERATE_TOKEN_URL), "*");
