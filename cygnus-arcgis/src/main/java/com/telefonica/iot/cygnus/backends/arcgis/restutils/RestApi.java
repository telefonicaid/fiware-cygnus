    ...
    protected static JsonElement getErrorJsonobject(JsonObject httpResponse) throws ArcgisException {
        ...
        try {
            if (httpResponse.has("error")) {
                result = httpResponse;
            } else if (httpResponse.has("addResults")) {
                result = httpResponse.get("addResults");
            } else if (httpResponse.has("updateResults")) {
                result = httpResponse.get("updateResults");
            } else if (httpResponse.has("deleteResults")) {
                result = httpResponse.get("deleteResults");
            }
        } catch (Exception e) {
            LOGGER.error(e);
