...
public class RestAuthentication extends RestApi{
    ...
    public static String tokenFromJson(String tokenJson, String tokenTag) throws ArcgisException {
    	String result = null;
    	if ("".equals(tokenTag)) tokenTag = ONLINE_RESPONSE_TOKEN_TAG;
    ...
    public static LocalDateTime expirationFromJson(String tokenJson, String expirationTag) throws ArcgisException {
    	...
    	if ("".equals(expirationTag)) expirationTag = ONLINE_RESPONSE_EXPIRES_TAG;
    ...
    * @throws ArcGisException 
     */
    public static Credential createUserToken(String user, String password,
          URL tokenGenUrl, String referer, Integer expirationMins) throws ArcgisException {
      ...
      try{
	      Map<String, String> bodyParams = new LinkedHashMap<String, String>();
		      ...
		      bodyParams.put("username", user);
		      if (expirationMins != null ) bodyParams.put("expiration", expirationMins.toString());
    ...
    * @throws ArcGisException 
     */
    public static Credential createUserToken(String user, String password,
          URL tokenGenUrl, String referer) throws ArcgisException {
     ...
     * @throws ArcgisException
     */
    public static Credential createToken( Credential credential,URL tokenGenUrl , String referer) throws ArcgisException {
