...
public class MongoBackendImplTest {
    ...
    public void testBuildQueryForInsertAggregated() {
        ...
        try {
            String query = backend.buildQueryForInsertAggregated(calendar, entityId,
                                    entityType, attrName, new boolean[]{ MongoBackendImpl.Resolution.SECOND }).toString();
        ...
        try {
            assertEquals(queryForInsertAggregated, backend.buildQueryForInsertAggregated(calendar, entityId,
                              entityType, attrName, new boolean[]{ MongoBackendImpl.Resolution.MINUTE }).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildQueryForInsertAggregated]")
        ...
        try {
            assertEquals(queryForInsertAggregated, backend.buildQueryForInsertAggregated(calendar, entityId,
                              entityType, attrName, new boolean[]{ MongoBackendImpl.Resolution.HOUR }).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildQueryForInsertAggregated]")
        ...
        try {
            assertEquals(queryForInsertAggregated, backend.buildQueryForInsertAggregated(calendar, entityId,
                              entityType, attrName, new boolean[]{ MongoBackendImpl.Resolution.DAY }).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildQueryForInsertAggregated]")
        ...
        try {
            assertEquals(queryForInsertAggregated, backend.buildQueryForInsertAggregated(calendar, entityId,
                              entityType, attrName, new boolean[]{ MongoBackendImpl.Resolution.MONTH }).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildQueryForInsertAggregated]")
    ...
    public void testBuildUpdateForUpdateString() {
        ...
        try {
            assertEquals(updateForUpdate, backend.buildUpdateForUpdate(attrType, new boolean[]{ MongoBackendImpl.Resolution.SECOND},
        ...
        try {
            assertEquals(updateForUpdate, backend.buildUpdateForUpdate(attrType, new boolean[]{ MongoBackendImpl.Resolution.MINUTE },
                    calendar, value, count).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildUpdateForUpdate]")
        ...
        try {
            assertEquals(updateForUpdate, backend.buildUpdateForUpdate(attrType, new boolean[]{ MongoBackendImpl.Resolution.HOUR },
                    calendar, value, count).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildUpdateForUpdate]")
        ...
        try {
            assertEquals(updateForUpdate, backend.buildUpdateForUpdate(attrType, new boolean[]{ MongoBackendImpl.Resolution.DAY},
                    calendar, value, count).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildUpdateForUpdate]")
        ...
        try {
            assertEquals(updateForUpdate, backend.buildUpdateForUpdate(attrType, new boolean[]{ MongoBackendImpl.Resolution.MONTH },
                    calendar, value, count).toString());
            System.out.println(getTestTraceHead("[MongoBackendImpl.buildUpdateForUpdate]")
