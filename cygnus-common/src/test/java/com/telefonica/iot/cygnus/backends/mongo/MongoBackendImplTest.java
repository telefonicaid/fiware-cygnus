...
public class MongoBackendImplTest {
    ...
    public void testGetRange() {
        ...
        MongoBackendImpl backend = new MongoBackendImpl(null, null, false, false, null, null, null, null);
    ...
    public void testBuildQueryForInsertAggregated() {
        ...
        GregorianCalendar calendar = new GregorianCalendar(2017, 3, 5, 11, 46, 13); // month 3 is April
        MongoBackendImpl backend = new MongoBackendImpl(null, DataModel.DMBYSERVICEPATH, false, false, null, null, null, null);
        ...
        backend = new MongoBackendImpl(null, DataModel.DMBYENTITY, false, false, null, null, null, null);
