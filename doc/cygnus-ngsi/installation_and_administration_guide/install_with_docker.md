...
* Configuration generation:
    * Handle generation of configuration: CYGNUS_SKIP_CONF_GENERATION. If enabled a configuration will be created for container, if disabled then your should provide a configuration file.
