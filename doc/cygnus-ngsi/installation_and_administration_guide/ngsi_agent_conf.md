...
# replicaset name if needed
#cygnus-ngsi.sinks.mongo-sink.mongo_replicaset = replicaset
# authSource for the mongoDB if needed
...
# replicaset name if needed
#cygnus-ngsi.sinks.sth-sink.mongo_replicaset = replicaset
# authSource for the mongoDB if needed
