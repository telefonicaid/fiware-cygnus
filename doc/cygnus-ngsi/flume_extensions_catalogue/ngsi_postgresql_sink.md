...
* Data model by entity database schema (`data_model=dm-by-entity-database-schema`) and entity type database schema (`data_model=dm-by-entity-type-database-schema`). For these datamodel the name of the schema will be auto generated by the sink, this name will be the `fiware-servicePath` found on the headers of the first request to store.
