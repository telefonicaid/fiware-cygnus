...
public class NGSIGenericColumnAggregator extends NGSIGenericAggregator {
    ...
    public void initialize(NGSIEvent event) {
        ...
        for (NotifyContextRequest.ContextAttribute contextAttribute : contextAttributes) {
            ...
            aggregation.put(attrName + "_typeAut0_G3n3r47eD_", new ArrayList<JsonElement>());
        } // for
    ...
    public void aggregate(NGSIEvent event) {
        ...
        for (NotifyContextRequest.ContextAttribute contextAttribute : contextAttributes) {
            ...
            if (aggregation.containsKey(attrName)) {
                ...
                aggregation.get(attrName + "_typeAut0_G3n3r47eD_").add(new JsonPrimitive(attrType));
            } else {
                ...
                aggregation.put(attrName + "_typeAut0_G3n3r47eD_", valuesType);
            } // if else
        } // for
