                ...
                while (it.hasNext()) {
                    ...
                    if (attrNativeTypes) {
                        ...
                        if (value == null || value.equals("")) {
                            ...
                            // TBD: = entry wrong way to get proper valueType ?
                            // Remember this code is the same for column and row aggregation
                            // attributeType = ?
                            if ( (attributeType == null) ||
                                 ((attributeType != null) && (!attributeType.equals("Number"))) ) {
                                value = "'" + value + "'";
                            } else {
