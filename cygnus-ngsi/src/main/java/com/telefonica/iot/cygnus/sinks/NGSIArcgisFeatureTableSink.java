...
//    private boolean attrMetadataStore;
    ...
    public void configure(Context context) {
        ...
        LOGGER.debug("[" + this.getName() + "] Reading configuration (arcgis_fearcgis_gettoken_urlature_table_url=" + getTokenUrl + ")");
...
public class NGSIArcgisAggregator {
    ...
    protected void contextAttrToFeature (Feature feature, ArrayList<ContextAttribute> contextAttributes){
		if (contextAttributes == null || contextAttributes.isEmpty()) {
	        ...
	        for (ContextAttribute contextAttribute : contextAttributes) {
	            LOGGER.debug("[NGSIArcgisAggregator-contextAttrToFeature] Processing Attribute: " + contextAttribute.toString());
	...
	//            String attrMetadata = parseJsonArrayStrToMetadataJson(contextAttribute.getContextMetadata());
	            LOGGER.debug("[NGSIArcgisAggregator] aggregate - Atribute (name --> " + attrName + ", type --> " + attrType
	                    + ", value --> " + attrValue + ", metadata= " + "ignored " + ")");
    ...
    switch (attrType){
    	...
    	case "geo:json":
    		try{
    			...
    			LOGGER.error("Invalid geo:json format, (sikipped): " + attrValue.toString() + " - Error: " + e.getMessage() );
    		}
    		break;
    	case "boolean":
            ...
            if (isQuoted(attrValue.toString())) {
                ...
                try {
                    ...
                    try {
                        ...
                        LOGGER.warn("[NGSIArcgisAggregator] Unquoted String attribute: " + attrName + ":"
                                + attrValue);
...
//    }
	...
	/**
	 * @param featureTableUrl the featureTableUrl to set
	 */
