...
public class NGSIPostgisSinkTest {
    ...
    /**
     * [NGSIPostgisSink.testBuildDBNameOldEncodingEntityTypeDatabaseDataModel] -------- The DB name is equals to the encoding of the notified/defaulted
     * service.
     * @throws java.lang.Exception
     */
    @Test
    public void testBuildDBNameOldEncodingEntityTypeDatabaseDataModel() throws Exception {
        System.out.println(getTestTraceHead("[NGSIPostgisSink.testBuildDBNameOldEncodingEntityTypeDatabaseDataModel]")
                + "-------- The db name is equals to the encoding of the notified/defaulted service");
        String attrPersistence = null; // default
        String batchSize = null; // default
        String batchTime = null; // default
    ...
    /**
     * [NGSIPostgisSink.testBuildDBNameNewEncodingEntityTypeDatabaseDataModel] -------- The DB name is equals to the encoding of the notified/defaulted
     * service.
     * @throws java.lang.Exception
     */
    @Test
    public void testBuildDBNameNewEncodingEntityTypeDatabaseDataModel() throws Exception {
        System.out.println(getTestTraceHead("[NGSIPostgisSink.testBuildDBNameNewEncodingEntityTypeDatabaseDataModel]")
                + "-------- The DB name is equals to the encoding of the notified/defaulted service");
        String attrPersistence = null; // default
        String batchSize = null; // default
        String batchTime = null; // default
    ...
    /**
     * [NGSIPostgisSink.buildTableName] -------- When a non root service-path is notified/defaulted and
     * data_model is 'dm-by-fixed-entity-type' the Postgis table name is the encoding of \<entity_type\>.
     * @throws java.lang.Exception
     */
    @Test
    ...
    } // testBuildTableNameNonRootServicePathDataModelByFixedEntityTypeOldEncoding

    /**
     * [NGSIPostgisSink.buildTableName] -------- When a non root service-path is notified/defaulted and
     * data_model is 'dm-by-fixed-entity-type' the PostgreSQL table name is the encoding of \<entity_type\>.
     * @throws java.lang.Exception
     */
    @Test
    ...
    } // testBuildTableNameNonRootServicePathDataModelByFixedEntityTypeNewEncoding
    ...
    public void testInitializeBuildTable() throws Exception {
        ...
        aggregator.setServicePathForNaming(event.getServicePathForNaming(false));
        aggregator.setEntityForNaming(event.getEntityForNaming(false, false));
        aggregator.setEntityType(event.getEntityTypeForNaming(false));
    ...
    private ContextElement createMappedContextElement2() {
        NotifyContextRequest notifyContextRequest = new NotifyContextRequest();
        ContextMetadata contextMetadata = new ContextMetadata();
        contextMetadata.setName("location");
        contextMetadata.setType("string");
        contextMetadata.setContextMetadata(new JsonPrimitive("NewWGS84"));
        ArrayList<ContextMetadata> metadata = new ArrayList<>();
        metadata.add(contextMetadata);
        ContextAttribute contextAttribute1 = new ContextAttribute();
        contextAttribute1.setName("someName1");
        ...
        contextAttribute2.setName("someName2");
        contextAttribute2.setType("someType2");
        contextAttribute2.setContextValue(new JsonPrimitive("someValue2New"));
        contextAttribute2.setContextMetadata(null);
        ArrayList<ContextAttribute> attributes = new ArrayList<>();
        attributes.add(contextAttribute1);
        attributes.add(contextAttribute2);
    ...
    public NGSIBatch setUpBatch() {
        ...
        headers.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE, mappedService);
        headers.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE_PATH, mappedServicePath);
        String timestamp2 = "1461136795800";
        String correlatorId2 = "123456789";
        String transactionId2 = "123456789";
        String originalService2 = "someService";
        String originalServicePath2 = "somePath";
        String mappedService2 = "newService";
        String mappedServicePath2 = "newPath";
        String destination2 = "someDestination";
        Map<String, String> headers2 = new HashMap<>();
        headers2.put(NGSIConstants.FLUME_HEADER_TIMESTAMP, timestamp2);
        headers2.put(CommonConstants.HEADER_CORRELATOR_ID, correlatorId2);
        headers2.put(NGSIConstants.FLUME_HEADER_TRANSACTION_ID, transactionId2);
        headers2.put(CommonConstants.HEADER_FIWARE_SERVICE, originalService2);
        headers2.put(CommonConstants.HEADER_FIWARE_SERVICE_PATH, originalServicePath2);
        headers2.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE, mappedService2);
        headers2.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE_PATH, mappedServicePath2);
        ...
        NGSIEvent ngsiEvent2 = new NGSIEvent(headers2, contextElement2.toString().getBytes(), contextElement2, createMappedContextElement());
        NGSIBatch batch = new NGSIBatch();
        batch.addEvent(destination, ngsiEvent);
        batch.addEvent(destination2, ngsiEvent2);
        return batch;
    }
    ...
    public NGSIBatch setUpBatchOverlappingEvents() {
        ...
        headers.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE, mappedService);
        headers.put(NGSIConstants.FLUME_HEADER_MAPPED_SERVICE_PATH, mappedServicePath);
        NotifyContextRequest.ContextElement contextElement = createMappedContextElement2();
        NGSIEvent ngsiEvent = new NGSIEvent(headers, contextElement.toString().getBytes(), contextElement, null);
    ...
    public void testNativeTypeColumnBatch() throws CygnusBadConfiguration{
        ...
        ngsiPostgisSink.configure(createContextforNativeTypes("column", null, null, null, null, null, null, null, null, null, null, null, attr_native_types));
        try {
            batch.startIterator();
    ...
    public void testNativeTypeColumnBatchLastDataKeyOtherThanEntityId() throws CygnusBadConfiguration{
        ...
        try {
            ...
            String valuesForInsert = SQLQueryUtils.getValuesForInsert(aggregator.getLastDataToPersist(), aggregator.isAttrNativeTypes());
            if (valuesForInsert.equals(correctBatch)) {
                System.out.println(getTestTraceHead("[NGSIPostgisSink.testNativeTypeColumnBatchLastDataKeyOtherThanEntityId]")
                        + "-  OK  - NativeTypesOK");
                assertTrue(true);
            } else {
                assertFalse(true);
    ...
    public void testNativeTypeColumnBatchLastDataNoKey() throws CygnusBadConfiguration{
        ...
        try {
            ...
            String valuesForInsert = SQLQueryUtils.getValuesForInsert(aggregator.getLastDataToPersist(), aggregator.isAttrNativeTypes());
            if (valuesForInsert.equals(correctBatch)) {
                System.out.println(getTestTraceHead("[NGSIPostgisSink.testNativeTypeColumnBatchLastDataNoKey]")
                        + "-  OK  - NativeTypesOK");
                assertTrue(true);
            } else {
                assertFalse(true);
    ...
    @Test
    public void testNativeTypeColumnBatchLastDataQuery() throws CygnusBadConfiguration{
        // Same as testNativeTypeColumnLastDataBatch() but testing postgreSqlUpsertQuery()
        // instead of getValuesForInsert()
        ...
        try {
            ...
            String valuesForInsert = SQLQueryUtils.getValuesForInsert(aggregator.getLastDataToPersist(), aggregator.isAttrNativeTypes());
            if (valuesForInsert.equals(correctBatch)) {
                System.out.println(getTestTraceHead("[NGSIPostgisSink.testNativeTypeColumnBatchLastDataQuery]")
                        + "-  OK  - NativeTypesOK");
                assertTrue(true);
            } else {
                assertFalse(true);
    ...
    @Test
    public void testNativeTypeColumnBatchLastDataKeyOtherThanEntityIdQuery() throws CygnusBadConfiguration{
        // Same as testNativeTypeColumnLastDataKeyOtherThanEntityIdQuery() but testing postgreSqlUpsertQuery()
        // instead of getValuesForInsert()
        // FIXME: as the function under test is postgreSqlUpsertQuery(), consider
        // move this to NGSIPostgreSQLSinkTest.java
        String attr_native_types = "true";
        ...
        try {
            ...
            String valuesForInsert = SQLQueryUtils.getValuesForInsert(aggregator.getLastDataToPersist(), aggregator.isAttrNativeTypes());
            if (valuesForInsert.equals(correctBatch)) {
                System.out.println(getTestTraceHead("[NGSIPostgisSink.testNativeTypeColumnBatchLastDataKeyOtherThanEntityIdQuery]")
                        + "-  OK  - NativeTypesOK");
                assertTrue(true);
            } else {
                assertFalse(true);
    ...
    @Test
    public void testNativeTypeColumnBatchLastDataNoKeyQuery() throws CygnusBadConfiguration{
        // Same as testNativeTypeColumnBatchLastDataNoKeyQuery() but testing postgreSqlUpsertQuery()
        // instead of getValuesForInsert()
        // FIXME: as the function under test is postgreSqlUpsertQuery(), consider
        // move this to NGSIPostgreSQLSinkTest.java
        String attr_native_types = "true";
        ...
        try {
            ...
            String valuesForInsert = SQLQueryUtils.getValuesForInsert(aggregator.getLastDataToPersist(), aggregator.isAttrNativeTypes());
            if (valuesForInsert.equals(correctBatch)) {
                System.out.println(getTestTraceHead("[NGSIPostgisSink.testNativeTypeColumnBatchLastDataNoKeyQuery]")
                        + "-  OK  - NativeTypesOK");
                assertTrue(true);
            } else {
                assertFalse(true);
