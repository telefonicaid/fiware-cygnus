...
MySQL organizes the data in databases that contain tables of data rows. Such organization is exploited by [`OrionCKANSink`](doc/design/OrionMySQLSink.md) each time a Flume event is taken from its channel.
