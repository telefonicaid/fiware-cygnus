...
* [`cygnus_translator_0.9.0_to_0.10.0_hdfs.sh`](#section4)
...
##<a name="section4"></a>`cygnus_translator_0.9.0_to_0.10.0_hdfs.sh`
...
```
$ ./cygnus_translator_0.9.0_to_0.10.0_hdfs.sh 
Usage: cygnus_translator_0.9.0_to_0.10.0_hdfs.sh hdfs_folder file_format null_value backup
...
```
$ ./cygnus_translator_0.9.0_to_0.10.0_hdfs.sh /user/johndoe/dataset json-row null false
```
