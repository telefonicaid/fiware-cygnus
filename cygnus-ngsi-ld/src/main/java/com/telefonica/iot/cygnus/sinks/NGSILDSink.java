...
public abstract class NGSILDSink extends CygnusSink implements Configurable {
     ...
     * @throws Exception
     */
    abstract void persistBatch(NGSILDBatch batch) throws CygnusBadConfiguration, CygnusBadContextData,
     ...
     */
    abstract void capRecords(NGSILDBatch batch, long maxRecords) throws CygnusCappingError;
