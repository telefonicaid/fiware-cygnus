...
if [ "${CYGNUS_MONGO_SKIP_CONF_GENERATION,,}" == "true" ]; then
    ...
    sed -i '/'${CYGNUS_AGENT_NAME}'.sinks.mongo-sink.mongo_replicaset/c '${CYGNUS_AGENT_NAME}'.sinks.mongo-sink.mongo_replicaset = '${CYGNUS_MONGO_REPLICASET} ${FLUME_HOME}/conf/${AGENT_CONF_FILE}
    ...
    sed -i '/'${CYGNUS_AGENT_NAME}'.sinks.sth-sink.mongo_replicaset/c '${CYGNUS_AGENT_NAME}'.sinks.sth-sink.mongo_replicaset = '${CYGNUS_MONGO_REPLICASET} ${FLUME_HOME}/conf/${AGENT_CONF_FILE}
