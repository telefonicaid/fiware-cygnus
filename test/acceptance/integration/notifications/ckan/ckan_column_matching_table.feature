...
Feature: Stored in ckan new notifications per column from context broker using matching table with patterns
  As a cygnus user
  I want to be able to store in ckan new notifications per column from context broker using matching table with patterns
