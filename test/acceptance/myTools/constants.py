...
DATASET                = u'dataset'
DATASTORE_SEARCH       = u'datastore_search'
DATASTORE_SEARCH_OFFSET= u'datastore_search_offset'
RESOURCE_ID            = u'resource_Id'
RESOURCE               = u'resources'
CKAN_HEADER            = u'ckan_header'
PATH_VERSION_CKAN      = u'api/util/status'
PATH_API_CREATE        = u'api/3/action'
PATH_DATASTORE_SEARCH  = PATH_API_CREATE + u'/datastore_search?resource_id='
PATH_PACKAGE_SHOW      = PATH_API_CREATE + u'/package_show?id='
OFFSET                 = u'&offset='
...
VALIDATE_ORGA_MSG     = u'...Organization is not created: '
